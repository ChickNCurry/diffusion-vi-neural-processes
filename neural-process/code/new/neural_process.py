...
class Decoder(nn.Module):
    def __init__(
        self, x_dim: int, r_dim: int, z_dim: int, h_dim: int, y_dim: int
    ) -> None:
    ...
    def reparameterize(self, y_mu: Tensor, y_w: Tensor) -> Tuple[Tensor, Tensor]:
        # (batch_size, y_dim), (batch_size, y_dim)
    ...
    def forward(
        ...
        # (batch_size, target_size, x_dim), (batch_size, r_dim), (batch_size, z_dim)
...
class NeuralProcess(nn.Module):
    def __init__(
        ...
        self.latent_encoder = LatentEncoder(x_dim, y_dim, h_dim, z_dim)
    ...
    def forward(
        ...
        # (batch_size, context_size, x_dim), (batch_size, context_size, y_dim), (batch_size, target_size, x_dim)

        r, z, _, _ = self.encode(x_context, y_context)
        # -> (batch_size, r_dim), (batch_size, z_dim)
